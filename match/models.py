...
class Match(db.Model):
    ...
    homeTeamCaptain_id = db.Column(db.Integer, db.ForeignKey(Player.id), nullable=False)
    awayTeamCaptain_id = db.Column(db.Integer, db.ForeignKey(Player.id), nullable=False)
