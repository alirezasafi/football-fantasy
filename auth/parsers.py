...
reset_password_parser.add_argument('old_password', required=True)
reset_password_parser.add_argument('new_password1', required=True)
reset_password_parser.add_argument('new_password2', required=True)